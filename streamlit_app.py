...
ax3.set_title('项目类型营收构成 (CRM vs 新产品) (%)')
ax3.set_xlabel('年份')
ax3.set_ylabel('百分比 (%)')
...
ax4.set_title('客户类型营收构成 (MNC vs 国内) (%)')
ax4.set_xlabel('年份')
ax4.set_ylabel('百分比 (%)')
...
ax_np.set_title('新产品营收类型构成 (百万美元)', fontsize=14)
ax_np.set_xlabel('年份', fontsize=12)
ax_np.set_ylabel('营收 (百万美元)', fontsize=12)
ax_np.set_xticks(years_for_plot)
ax_np.grid(axis='y', linestyle='--', alpha=0.7)
ax_np.legend(title='产品类型', bbox_to_anchor=(1.05, 1), loc='upper left')
plt.tight_layout()
st.pyplot(fig_np)
